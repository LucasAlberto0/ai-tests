...
export class Icon {
  ...
  get svgContent() {
    // Basic mock of icons logic. We will hardcode a few SVGs based on name.
    const icons: Record<string, string> = {
      ...
      'chart': `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 3v18h18v-2H5V3H3zm6 14l3-3 4 4 6-6-1.4-1.4-4.6 4.6-4-4-4.4 4.4z"/></svg>`,
